...
# datas = "{ \"Category 1\": [ (\"New Game 2\", \"Playnite\", \"\", \"\", \"Never\", \"Not Played\", \"\"), (\"New Game\", \"Playnite\", \"\", \"\", \"Never\", \"Not Played\", \"\")] \"No Category\": [(\"New Game\", \"Playnite\", \"\", \"\", \"Never\", \"Not Plated\", \"\")]} "
#
# data = "{ \"Category\": \"1\"}"
#
# print(datas)

from database import client_controller

print(client_controller.get_clients_data_set())